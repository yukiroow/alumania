        ...
        <div className="relative flex justify-center items-center h-[34px] mt-7 text-[14px] text-white/60 gap-0.5">
            ...
            <div className="dropdown dropdown-bottom relative">
                ...
                {isFilterDropdownOpen && (
                    <ul
                        tabIndex={0}
                        className="absolute dropdown-content menu bg-white rounded-box z-50 w-[145px] p-2 right-0 shadow border mt-2"
                    >
                        {filters.map((filter) => (
                            <li key={filter}>
                                <a
                                    className="block py-1 text-center text-[#7C7575] hover:bg-gray-200 hover:text-[#022543] hover:font-bold"
            ...
            <div className="relative">
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    className="cursor-pointer w-6 h-6 text-gray-500 hover:text-gray-700 ml-5"
                ...
                {isSortDropdownOpen && (
                    <div className="absolute dropdown-content menu left-5 mt-5 bg-white shadow-lg rounded-lg w-28 text-[#7C7575] z-10">
